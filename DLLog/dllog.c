...
void
setLogPrintLevel(log_level_type logLevel){
...
void
setLogWriteLevel(log_level_type logLevel){
...
void
setOpenAssertLevel(log_level_type logLevel){
...
void
setLogFilePath(const char* filePath){
...
void
setIsOpenAssert(int isOpenAssert){
...
static
char*
_mallocStrFormat(const char* str,...){
    va_list argptr;
    int needreadcount;
...
static
void
_createFilePath(const char* filePath){
    DIR* dirptr = NULL;
    struct dirent* entry;
...
static
void
_writeLogToFile(int log_level, const char* str, int line, const char* func, const char* file, const char* log_level_str){
...
static
void
_dealLogModeRelease(int log_level, const char* str, int line, const char* func, const char* file, const char* log_level_str){
    printf("%s\n",str);
}

static
void
_dealLogModeDevelop(int log_level, const char* str, int line, const char* func, const char* file, const char* log_level_str){
...
static
void
_dealLogModeDebug(int log_level, const char* str, int line, const char* func, const char* file, const char* log_level_str){
...
static
void
_checkLogMode(int log_level, const char* str, int line, const char* func, const char* file, const char* log_level_str){
...
static
int
_checkIsSystemError(log_level_type log_level, const char** str){
    int isSysError = 0;
...
static
void
__FreeMemorySysErrorStr(const char* str, int isSysError){
    if (isSysError)
...
static
void
_checkIsAssertAbort(int log_level){
...
static
void
_DLlog(log_level_type log_level, int line, const char* func, const char* file,const char* str){
...
void
DLlogFormat(log_level_type log_level, int line, const char* func, const char* file,const char* str,...){
    va_list argptr;
    int needreadcount;
    int strbuffersize = 1024;
    char* strbuffer = _mallocBuffer(strbuffersize);
